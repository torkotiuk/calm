class Car {
   ...
   * при условии что результирующая скорость не меньше 
   * нуля
   */
  decelerate(value) {
  ...
  drive(hours) {
    ...
    return console.log('Distance in method: ', this.totalDistance += this.distance);
...
// totalDistance += mustang.distance;
...
// console.log(totalDistance += mustang.distance);
console.log(mustang.distance);
